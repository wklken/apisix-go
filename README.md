...
- [x] [request-validation](https://apisix.apache.org/zh/docs/apisix/plugins/request-validation/) 75%
  - support JSON `body_schema`, `header_schema`, `rejected_code`, and `rejected_msg`
  - not support `application/x-www-form-urlencoded` body validation or JSON body normalization before proxying
