...
- [x] [error-log-logger](https://apisix.apache.org/zh/docs/apisix/plugins/error-log-logger/) 69%
  ...
  - not support direct `ngx.errlog` capture, OpenResty timer lifecycle, APISIX batch route/server label population, stale-object cleanup exactness, Lua-resty-kafka producer cache exactness, or encrypted metadata fields
