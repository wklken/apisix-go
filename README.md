...
- [x] [http-logger](https://apisix.apache.org/zh/docs/apisix/plugins/http-logger/) 76%
  - support `uri`, `auth_header`, `timeout`, `log_format`, `concat_method`, `ssl_verify`, HTTP POST delivery, `include_req_body`, `include_req_body_expr`, `include_resp_body`, `include_resp_body_expr`, capped body-size capture, APISIX batch processor fields (`batch_max_size`, `max_retry_count`, `retry_delay`, `buffer_duration`, `inactive_timeout`), JSON/newline batch payloads, `max_pending_entries`, and the route-aware shared `batch_process_entries` gauge hook
  - not support APISIX batch processor `server_addr` label population, stale-object cleanup exactness, or encrypted `auth_header`
- [x] [skywalking-logger](https://apisix.apache.org/zh/docs/apisix/plugins/skywalking-logger/) 76%
  ...
  - not support APISIX batch `server_addr` label population or stale-object cleanup exactness
- [x] [tcp-logger](https://apisix.apache.org/zh/docs/apisix/plugins/tcp-logger/) 70%
  ...
  - not support OpenResty cosocket connection pooling, APISIX batch `server_addr` label population, or stale-object cleanup exactness
...
- [x] [clickhouse-logger](https://apisix.apache.org/zh/docs/apisix/plugins/clickhouse-logger/) 76%
  ...
  - not support APISIX batch `server_addr` label population, stale-object cleanup exactness, or encrypted `password`
- [x] [syslog](https://apisix.apache.org/zh/docs/apisix/plugins/syslog/) 70%
  ...
  - not support OpenResty syslog connection pooling/TLS behavior parity, APISIX batch `server_addr` label population, or stale-object cleanup exactness
...
- [x] [error-log-logger](https://apisix.apache.org/zh/docs/apisix/plugins/error-log-logger/) 69%
  ...
  - not support direct `ngx.errlog` capture, OpenResty timer lifecycle, APISIX batch `server_addr` label population, stale-object cleanup exactness, Lua-resty-kafka producer cache exactness, or encrypted metadata fields
- [x] [sls-logger](https://apisix.apache.org/zh/docs/apisix/plugins/sls-logger/) 72%
  ...
  - not support APISIX batch `server_addr` label population, stale-object cleanup exactness, or encrypted `access_key_secret`
...
- [x] [loggly](https://apisix.apache.org/zh/docs/apisix/plugins/loggly/) 76%
  ...
  - not support APISIX batch `server_addr` label population, stale-object cleanup exactness, or encrypted `customer_token`
- [x] [elasticsearch-logger](https://apisix.apache.org/zh/docs/apisix/plugins/elasticsearch-logger/) 84%
  ...
  - not support APISIX batch `server_addr` label population, stale-object cleanup exactness, or encrypted `auth.password`
- [x] [tencent-cloud-cls](https://apisix.apache.org/zh/docs/apisix/plugins/tencent-cloud-cls/) 76%
  ...
  - not support APISIX batch `server_addr` label population, stale-object cleanup exactness, or encrypted `secret_key`
