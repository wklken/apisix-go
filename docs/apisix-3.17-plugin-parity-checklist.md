...
| `fault-injection` | yes | 80% | monitor |
...
| `openid-connect` | yes | 50% | implement |
...
| `loki-logger` | yes | 60% | implement |
| `elasticsearch-logger` | yes | 73% | monitor |
| `echo` | yes | 90% | monitor |
