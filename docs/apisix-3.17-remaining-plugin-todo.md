...
| `lago` | Remaining gaps are fuller APISIX/NGINX variable template coverage, encrypted `token`, and request start-time fidelity. APISIX `batch_max_size` default of 100 is implemented. |
