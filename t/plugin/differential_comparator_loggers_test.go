...
func TestCompareDifferentialLoggerFixtureDeliveryAcceptsUnorderedSemanticCalls(t *testing.T) {
	for _, test := range []struct {
		...
		{
			name: "clickhouse",
			spec: differentialClickHouseLoggerCases()[0], compare: compareDifferentialClickHouseLoggerFixtureDelivery,
			pair: differentialClickHouseLoggerComparatorObservations,
		},
		{
			name: "elasticsearch",
			spec: differentialElasticsearchLoggerCases()[0], compare: compareDifferentialElasticsearchLoggerFixtureDelivery,
			pair: differentialElasticsearchLoggerComparatorObservations,
		},
		{
			name: "http",
			spec: differentialHTTPLoggerCases()[0], compare: compareDifferentialHTTPLoggerFixtureDelivery,
			pair: differentialHTTPLoggerComparatorObservations,
		},
		{
			name: "loki",
			spec: differentialLokiLoggerCases()[0], compare: compareDifferentialLokiLoggerFixtureDelivery,
			pair: differentialLokiLoggerComparatorObservations,
		},
		{
			name: "splunk",
			spec: differentialSplunkHECLoggingCases()[0], compare: compareDifferentialSplunkHECLoggingFixtureDelivery,
			pair: differentialSplunkLoggerComparatorObservations,
		},
		{
			name: "tencent-cls",
			spec: differentialTencentCloudCLSCases()[0], compare: compareDifferentialTencentCloudCLSFixtureDelivery,
...
func TestCompareDifferentialLoggerFixtureDeliveryTreatsEmptyQueryMarkerAsEquivalent(t *testing.T) {
	for _, test := range []struct {
		...
		{
			name: "clickhouse", spec: differentialClickHouseLoggerCases()[0],
		...
		{
			name: "http", spec: differentialHTTPLoggerCases()[0],
...
func TestCompareDifferentialLoggerFixtureDeliveryRejectsAdditionalQueryParameters(t *testing.T) {
	spec := differentialElasticsearchLoggerCases()[0]
...
func TestCompareDifferentialLoggerFixtureDeliveryRejectsLooseContracts(t *testing.T) {
	for _, test := range []struct {
		...
		{
			name: "unpinned case", spec: differentialHTTPLoggerCases()[0],
			compare: compareDifferentialHTTPLoggerFixtureDelivery,
			pair:    differentialHTTPLoggerComparatorObservations,
		...
		{
			name: "wrong gateway response", spec: differentialClickHouseLoggerCases()[0],
			compare: compareDifferentialClickHouseLoggerFixtureDelivery,
			pair:    differentialClickHouseLoggerComparatorObservations,
		...
		{
			name: "missing origin", spec: differentialLokiLoggerCases()[0],
		...
		{
			name: "wrong origin host", spec: differentialHTTPLoggerCases()[0],
			compare: compareDifferentialHTTPLoggerFixtureDelivery,
			pair:    differentialHTTPLoggerComparatorObservations,
		...
		{
			name: "clickhouse missing credential header", spec: differentialClickHouseLoggerCases()[0],
			compare: compareDifferentialClickHouseLoggerFixtureDelivery,
			pair:    differentialClickHouseLoggerComparatorObservations,
			mutate: func(_ *DifferentialCase, candidate, _ *DifferentialObservation) {
		...
		{
			name: "clickhouse malformed JSON row", spec: differentialClickHouseLoggerCases()[0],
			compare: compareDifferentialClickHouseLoggerFixtureDelivery,
			pair:    differentialClickHouseLoggerComparatorObservations,
			mutate: func(_ *DifferentialCase, _, oracle *DifferentialObservation) {
		...
		{
			name: "elasticsearch extra NDJSON line", spec: differentialElasticsearchLoggerCases()[0],
		...
		{
			name: "http wrong auth", spec: differentialHTTPLoggerCases()[0],
			compare: compareDifferentialHTTPLoggerFixtureDelivery,
			pair:    differentialHTTPLoggerComparatorObservations,
			mutate: func(_ *DifferentialCase, _, oracle *DifferentialObservation) {
		...
		{
			name: "loki missing tenant", spec: differentialLokiLoggerCases()[0],
			compare: compareDifferentialLokiLoggerFixtureDelivery,
			pair:    differentialLokiLoggerComparatorObservations,
			mutate: func(_ *DifferentialCase, candidate, _ *DifferentialObservation) {
		...
		{
			name: "loki bad timestamp", spec: differentialLokiLoggerCases()[0],
			compare: compareDifferentialLokiLoggerFixtureDelivery,
			pair:    differentialLokiLoggerComparatorObservations,
			mutate: func(_ *DifferentialCase, _, oracle *DifferentialObservation) {
		...
		{
			name: "splunk wrong token", spec: differentialSplunkHECLoggingCases()[0],
		...
		{
			name: "splunk wrong event", spec: differentialSplunkHECLoggingCases()[0],
			compare: compareDifferentialSplunkHECLoggingFixtureDelivery,
			pair:    differentialSplunkLoggerComparatorObservations,
			mutate: func(_ *DifferentialCase, _, oracle *DifferentialObservation) {
		...
		{
			name: "cls malformed protobuf", spec: differentialTencentCloudCLSCases()[0],
		...
		{
			name: "cls invalid signature", spec: differentialTencentCloudCLSCases()[0],
			compare: compareDifferentialTencentCloudCLSFixtureDelivery,
			pair:    differentialTencentCLSLoggerComparatorObservations,
			mutate: func(_ *DifferentialCase, _, oracle *DifferentialObservation) {
...
func TestCompareDifferentialLoggerFixtureDeliveryKeepsNonvolatileFieldsStrict(t *testing.T) {
	spec := differentialHTTPLoggerCases()[0]
