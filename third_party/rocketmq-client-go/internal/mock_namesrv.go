...
func (m *MockNamesrvs) UpdateTopicRouteInfoContext(_ context.Context, topic string) (*TopicRouteData, bool, error) {
	return m.UpdateTopicRouteInfo(topic)
}

func (m *MockNamesrvs) UpdateTopicRouteInfoWithDefaultContext(_ context.Context, topic string, defaultTopic string, defaultQueueNum int) (*TopicRouteData, bool, error) {
	return m.UpdateTopicRouteInfoWithDefault(topic, defaultTopic, defaultQueueNum)
}
