...
type Namesrvs interface {
	...
	UpdateTopicRouteInfoContext(ctx context.Context, topic string) (routeData *TopicRouteData, changed bool, err error)

	UpdateTopicRouteInfoWithDefault(
		topic string,
		defaultTopic string,
		defaultQueueNum int,
	) (*TopicRouteData, bool, error)
	UpdateTopicRouteInfoWithDefaultContext(
		ctx context.Context,
		topic string,
		defaultTopic string,
		defaultQueueNum int,
